...
import main.AdminMenuHandler.AdminUser;
import main.CustomerMenuHandler.Customer;
import main.StaffMenuHandler.Staff;
import model.User;
import util.Config;
...
public class UserService {
    ...
    private static final String ADMIN_FILE = Config.ADMIN_FILE;
    private static final String STAFF_FILE = Config.STAFF_FILE;
    private static final String CUSTOMER_FILE = Config.CUSTOMER_FILE;
    ...
    public UserService() {
        ...
        if (userCount == 0) {
            createUser(new AdminUser("admin", "123", "System Admin"));
    ...
    private void displayAllUsers() {
        ...
        for (int i = 0; i < userCount; i++) {
            ...
            String role = (u instanceof AdminUser) ? "ADMIN"
    ...
    public int[] getFilteredIndexes(int type) {
        ...
        for (int i = 0; i < userCount; i++) {
            ...
            if (type == 1 && users[i] instanceof AdminUser) temp[count++] = i;
